...
ParticleSystem::ParticleSystem(Texture* texture)
{
    ...
    simulationProgram->AttachShader(new Shader("../shaders/compute.glsl", GL_COMPUTE_SHADER));
    ...
    m_particleRenderMat->SetTexture("tex", texture);
...
void ParticleSystem::Update(float dt)
{
    ...
    m_particleSimulateMat->SetFloat("dt", dt);
    m_particleSimulateMat->SetFloat("burnRate", 1 / (float)m_lifeTime);
    m_particleSimulateMat->SetVec3("basePosition", m_position);
    m_particleSimulateMat->SetVec3("acceleration", m_acceleration);
...
void ParticleSystem::Draw()
{
    ...
    m_particleRenderMat->SetVec2("particleSize", m_particleSize);
